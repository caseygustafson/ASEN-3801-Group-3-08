...
%% Subplots for Relative Position in Body Frame
figure(3)
subplot(3,1,1)
plot(t_vec,rel_B(1,:),'LineWidth',1.5)
xlabel('time (s)')
ylabel('X-Component')
title('Relative Postion of Target to Vehicle in B-Frame')

subplot(3,1,2)
plot(t_vec,rel_B(2,:),'LineWidth',1.5)
xlabel('time (s)')
ylabel('Y-Component')

subplot(3,1,3)
plot(t_vec,rel_B(3,:),'LineWidth',1.5)
xlabel('time (s)')
ylabel('Z-Component')